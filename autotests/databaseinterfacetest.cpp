...
private Q_SLOTS:
    ...
    {
        DatabaseInterface musicDb;
        musicDb.allData(DataUtils::DataType::AllArtists);
    }
    ...
    void addOneTrackWithoutAlbumArtist()
    {
        ...
        QCOMPARE(musicDb.allData(DataUtils::DataType::AllArtists).count(), 0);
        ...
        QCOMPARE(musicDb.allData(DataUtils::DataType::AllArtists).count(), 1);
    ...
    void addAndRemoveOneTrackWithoutAlbum()
    {
        ...
        auto track = musicDb.trackFromDatabaseId(musicDb.trackIdFromFileName(QUrl::fromLocalFile(QStringLiteral("/$24"))));
    ...
    void addAndRemoveOneTrackWithoutTrackNumber()
    {
        ...
        auto newTrack = MusicAudioTrack {true, QStringLiteral("$26"), QStringLiteral("0"), QStringLiteral("track12"),
        ...
        auto track = musicDb.trackFromDatabaseId(musicDb.trackIdFromFileName(QUrl::fromLocalFile(QStringLiteral("/$26"))));
    ...
    void addAndRemoveOneTrackWithoutArtist()
    {
        ...
        auto newTrack = MusicAudioTrack {true, QStringLiteral("$26"), QStringLiteral("0"), QStringLiteral("track11"),
    ...
    void addOneTrackWithoutAlbumArtistAndAnotherTrackWith()
    {
        ...
        newTrack = MusicAudioTrack {true, QStringLiteral("$27"), QStringLiteral("0"), QStringLiteral("track12"),
        ...
        QCOMPARE(musicDb.allData(DataUtils::DataType::AllArtists).count(), 2);
    ...
    void addThreeTracksWithoutAlbumArtistButSameArtist()
    {
        ...
        QCOMPARE(thirdTrack.albumId(), qulonglong(1));
    ...
    void addTwoTracksWithPartialAlbumArtist()
    {
        ...
        QCOMPARE(musicDb.allAlbums().count(), 1);
        QCOMPARE(musicDb.allData(DataUtils::DataType::AllArtists).count(), 3);
        QCOMPARE(musicDb.allTracks().count(), 2);
        QCOMPARE(musicDbArtistAddedSpy.count(), 1);
        QCOMPARE(musicDbAlbumAddedSpy.count(), 1);
        QCOMPARE(musicDbTrackAddedSpy.count(), 1);
    ...
    void restoreModifiedTracksWidthDatabaseFile()
    {
...

        {
            ...
            QCOMPARE(musicDb.allAlbums().count(), 5);
            QCOMPARE(musicDb.allData(DataUtils::DataType::AllArtists).count(), 7);
    ...
    void fetchAllTracksFromSource()
    {
        ...
        QCOMPARE(musicDb.allAlbums().count(), 5);
        QCOMPARE(musicDb.allData(DataUtils::DataType::AllArtists).count(), 8);
        QCOMPARE(musicDb.allTracks().count(), 23);
    ...
    void removeOneAlbum()
    {
        ...
        QCOMPARE(musicDb.allData(DataUtils::DataType::AllArtists).count(), 6);
        ...
        auto removedAlbum = musicDb.albumFromTitleAndArtist(QStringLiteral("album2"), QStringLiteral("artist1"));
    ...
    void reloadDatabaseWithAllTracks()
    {
        ...
        QCOMPARE(musicDb2.allData(DataUtils::DataType::AllArtists).count(), 0);
        ...
        QCOMPARE(musicDb2.allData(DataUtils::DataType::AllArtists).count(), 7);
    ...
    void testRemovalOfTracksFromValidSource()
    {
        ...
        QList<MusicAudioTrack> secondNewTracks = {
            ...
            {true, QStringLiteral("$28"), QStringLiteral("0"), QStringLiteral("track6"),
             ...
             QDateTime::fromMSecsSinceEpoch(28),
            ...
            {true, QStringLiteral("$29"), QStringLiteral("0"), QStringLiteral("track2"),
             ...
             QDateTime::fromMSecsSinceEpoch(29),
    ...
    void addTowAlbumsWithDifferentPathsAndSameName()
    {
        ...
        QCOMPARE(musicDb.allAlbums().count(), 2);
        QCOMPARE(musicDb.allData(DataUtils::DataType::AllArtists).count(), 4);
        QCOMPARE(musicDb.allTracks().count(), 4);
        QCOMPARE(musicDbArtistAddedSpy.count(), 1);
        QCOMPARE(musicDbAlbumAddedSpy.count(), 1);
        QCOMPARE(musicDbTrackAddedSpy.count(), 1);
        QCOMPARE(musicDbArtistRemovedSpy.count(), 0);
        ...
        QCOMPARE(musicDb.allAlbums().size(), 2);
        QCOMPARE(musicDb.allData(DataUtils::DataType::AllArtists).size(), 4);
        QCOMPARE(musicDb.allTracks().size(), 4);

        auto allAlbums = musicDb.allAlbums();
        auto firstAlbum = allAlbums[0];
        QCOMPARE(firstAlbum.tracksCount(), 2);
        auto secondAlbum = allAlbums[1];
        QCOMPARE(secondAlbum.tracksCount(), 2);
    }

    void addTowAlbumsWithDifferentPathsAndSameTracks()
    {
        QTemporaryFile databaseFile;
        databaseFile.open();
        ...
        QCOMPARE(musicDb.allAlbums().count(), 2);
        QCOMPARE(musicDb.allData(DataUtils::DataType::AllArtists).count(), 3);
        QCOMPARE(musicDb.allTracks().count(), 6);
        QCOMPARE(musicDbArtistAddedSpy.count(), 1);
        QCOMPARE(musicDbAlbumAddedSpy.count(), 1);
        QCOMPARE(musicDbTrackAddedSpy.count(), 1);
        QCOMPARE(musicDbArtistRemovedSpy.count(), 0);
        ...
        auto allAlbums = musicDb.allAlbums();
        auto firstAlbum = allAlbums[0];
        QCOMPARE(firstAlbum.tracksCount(), 3);
        auto secondAlbum = allAlbums[1];
        QCOMPARE(secondAlbum.tracksCount(), 3);
    }
    ...
    void addTwoTracksFromSameAlbumButDifferentDiscs()
    {
        ...
        auto newTrack2 = MusicAudioTrack{true, QStringLiteral("$25"), QStringLiteral("0"), QStringLiteral("track8"),
