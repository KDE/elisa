...
private Q_SLOTS:
    ...
    void removeOneTrack()
    {
        ...
        albumsModel.initializeByAlbumTitleAndArtist(nullptr, ElisaUtils::Track, QStringLiteral("album1"), QStringLiteral("Various Artists"));
    ...
    void removeOneAlbum()
    {
        ...
        albumsModel.initializeByAlbumTitleAndArtist(nullptr, ElisaUtils::Track, QStringLiteral("album3"), QStringLiteral("artist2"));
    ...
    void removeOneTrackAllAlbums()
    {
        ...
        albumsModel.initialize(nullptr, ElisaUtils::Album);
    ...
    void removeOneArtistAllArtists()
    {
        ...
        connect(&musicDb, &DatabaseInterface::artistsAdded,
                &artistsModel, &DataModel::artistsAdded);
        connect(&musicDb, &DatabaseInterface::artistRemoved,
                &artistsModel, &DataModel::artistRemoved);
        ...
        artistsModel.initialize(nullptr, ElisaUtils::Artist);
