    ...
    QList<ViewParameters> mViewsParameters = {{{i18nc("Title of the view of the playlist", "Now Playing")},
                                              ...
                                              {{i18nc("Title of the view of all tracks", "Tracks")},
                                               ...
                                               {DataTypes::TitleRole, DataTypes::AlbumRole, DataTypes::ArtistRole,
                                                ...
                                                DataTypes::ComposerRole, DataTypes::LyricistRole, DataTypes::FileCreationTime},
                                               {i18n("Title"), i18n("Album"), i18n("Artist"), i18n("Genre"), i18n("Year"), i18n("Duration"), i18n("Composer"), i18n("Lyricist"), i18n("File Created Time")},
                                               Qt::AscendingOrder,
                                               {i18n("A-Z"), i18n("Z-A"), i18n("A-Z"), i18n("Z-A"), i18n("A-Z"), i18n("Z-A"), i18n("A-Z"), i18n("Z-A"),
                                                i18n("Oldest First"), i18n("Newest First"), i18n("Shortest First"), i18n("Longest First"), i18n("A-Z"), i18n("Z-A"), i18n("A-Z"), i18n("Z-A"), i18n("Oldest First"), i18n("Newest First")},
                                               ViewManager::MultipleAlbum,
                                               ViewManager::NoDiscHeaders,
                                               ViewManager::IsTrack,
                                               ViewManager::IsFlatModel},
