...
private Q_SLOTS:
    ...
    void addOneTrack()
    {
        ...
        {QUrl::fromLocalFile(QStringLiteral("file://image$24"))}, 5, true, {}, QStringLiteral("composer1")};
    ...
    void modifyOneTrack()
    {
        ...
        auto modifiedTrack = MusicAudioTrack{
            ...
            {QUrl::fromLocalFile(QStringLiteral("file://image$3"))}, 5, true, {}, QStringLiteral("composer1")};
